...
/**
 * @Author liuht
 * @Date 2023/8/29 20:19
 * @Version 1.0
 * @Description 参数表达式
 */
public class ParmeterExpression extends HashMap<String, String> {
    private static final long serialVersionUID = -6327652199605158680L;

    public ParmeterExpression(String expression) {
        parse(expression);
    }
